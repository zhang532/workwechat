...
use WorkWechat\Kernel\Exceptions\BadRequestException;
use WorkWechat\Kernel\Exceptions\InvalidArgumentException;
use WorkWechat\Kernel\Messages\Message;
use WorkWechat\Kernel\Messages\News;
use WorkWechat\Kernel\Messages\NewsItem;
use WorkWechat\Kernel\Messages\Raw as RawMessage;
use WorkWechat\Kernel\Messages\Text;
use WorkWechat\Kernel\Support\XML;
use WorkWechat\Kernel\Traits\Observable;
use WorkWechat\Kernel\Traits\ResponseCastable;
...
class ServerGuard
{
     ...
     * Get request message.
     *
     * @return array|\WorkWechat\Kernel\Support\Collection|object|string
     *
     * @throws BadRequestException
     * @throws \WorkWechat\Kernel\Exceptions\InvalidArgumentException
     * @throws \WorkWechat\Kernel\Exceptions\InvalidConfigException
    ...
    /**
     * @param \WorkWechat\Kernel\Contracts\MessageInterface|string|int $message
     *
     * @return string
     *
     * @throws \WorkWechat\Kernel\Exceptions\InvalidArgumentException
