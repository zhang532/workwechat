...
use WorkWechat\OfficialAccount;

/**
 * Class Application.
 *
 * @property \WorkWechat\Payment\Bill\Client              $bill
 * @property \WorkWechat\Payment\Fundflow\Client          $fundflow
 * @property \WorkWechat\Payment\Jssdk\Client             $jssdk
 * @property \WorkWechat\Payment\Order\Client             $order
 * @property \WorkWechat\Payment\Refund\Client            $refund
 * @property \WorkWechat\Payment\Coupon\Client            $coupon
 * @property \WorkWechat\Payment\Reverse\Client           $reverse
 * @property \WorkWechat\Payment\Redpack\Client           $redpack
 * @property \WorkWechat\BasicService\Url\Client          $url
 * @property \WorkWechat\Payment\Transfer\Client          $transfer
 * @property \WorkWechat\Payment\Security\Client          $security
 * @property \WorkWechat\Payment\ProfitSharing\Client     $profit_sharing
 * @property \WorkWechat\Payment\Contract\Client          $contract
