...
namespace WorkWechat\OfficialAccount\Broadcasting;

use WorkWechat\Kernel\BaseClient;
use WorkWechat\Kernel\Contracts\MessageInterface;
use WorkWechat\Kernel\Exceptions\RuntimeException;
use WorkWechat\Kernel\Messages\Card;
use WorkWechat\Kernel\Messages\Image;
use WorkWechat\Kernel\Messages\Media;
 ...
 * Class Client.
 *
 * @method \Psr\Http\Message\ResponseInterface|\WorkWechat\Kernel\Support\Collection|array|object|string previewTextByName($text, $name);
 * @method \Psr\Http\Message\ResponseInterface|\WorkWechat\Kernel\Support\Collection|array|object|string previewNewsByName($mediaId, $name);
 * @method \Psr\Http\Message\ResponseInterface|\WorkWechat\Kernel\Support\Collection|array|object|string previewVoiceByName($mediaId, $name);
 * @method \Psr\Http\Message\ResponseInterface|\WorkWechat\Kernel\Support\Collection|array|object|string previewImageByName($mediaId, $name);
 * @method \Psr\Http\Message\ResponseInterface|\WorkWechat\Kernel\Support\Collection|array|object|string previewVideoByName($message, $name);
 * @method \Psr\Http\Message\ResponseInterface|\WorkWechat\Kernel\Support\Collection|array|object|string previewCardByName($cardId, $name);
 *
